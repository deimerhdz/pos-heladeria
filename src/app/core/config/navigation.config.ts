...
export const NAV_ITEMS: NavItem[] = [
  // ── PRINCIPAL ──────────────────────────────────────────────────────────
  { label: 'Dashboard', icon: 'dashboard', route: '/dashboard/admin', group: 'PRINCIPAL', roles: [UserRole.ADMIN] },
  { label: 'Ventas', icon: 'sales', route: '/dashboard/ventas', group: 'PRINCIPAL', roles: [UserRole.ADMIN, UserRole.CASHIER] },
  ...
  { label: 'Presentaciones', icon: 'categories', route: '/dashboard/presentations', group: 'CATÁLOGO', roles: [UserRole.ADMIN] },
  ...
  { label: 'Ajustes', icon: 'settings', route: '/dashboard/ajustes', group: 'ADMINISTRACIÓN', roles: [UserRole.ADMIN] },
];
